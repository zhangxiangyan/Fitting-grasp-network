...
from myutils.utils_fit_rot_rect_grasp import *
...
"""
####加载模型
model=keras.models.load_model('h5/grasp_simple_deeplabv3_xception_all.h5')
...
旋转矩形拟合
"""
grasp_point,grasp_angle=rot_rect_grasp_ang('img/pred_seg.png')
...
for i in range(len(points)):
    gripper.append(mesh_gripper(points[i],Rs[i],0.09,0.02, scores))
